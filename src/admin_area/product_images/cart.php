	 ...
	 <div id="shopping_cart">
	       <span style="float:right;font-size:18px;padding:5px;line-height:35px;">
		    ...
		    <?php 
		     ...
		     <b style="color:yellow">Shopping Cart- </b>Total Items:<?php total_items(); ?>  Total Price: <?php total_price(); ?> <a href="checkout.php" style="color:red;text-decoration:none">checkout</a>
		...
		while($price = mysqli_fetch_array($run_query)){
		   ...
		   ?>
			...
			<td><input type="number" size="4" name="qty" value = "<?php echo $_SESSION['qty'] ?>" min=1 max=5></td>
			<?php
